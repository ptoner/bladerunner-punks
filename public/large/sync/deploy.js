...
class ProcessConfig {
    ...
    static getSyncPushConfig(config) {
...
module.exports = JSON.parse('{"hostname":"http://localhost:8081","baseURL":"/","maxItems":100000,"marketplaces":[{"name":"OpenSea","assetLink":"https://opensea.io/assets/ethereum/{contractId}/{tokenId}"},{"name":"LooksRare","link":"https://looksrare.org/collections/{contractId}","assetLink":"https://looksrare.org/collections/{contractId}/{tokenId}"}]}');
...
/* harmony import */ var _reader_util_process_config_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../reader/util/process-config.js */ "./src/reader/util/process-config.ts");
/* harmony import */ var _service_spawn_service_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./service/spawn-service.js */ "./src/sync/service/spawn-service.ts");
...
let deploy = async () => {
    ...
    await spawnService.spawnGoogleCloudSync(config.baseDir, config.deploy.googleCloud.bucketName, config.deploy.googleCloud.destinationDir);
};
deploy();
